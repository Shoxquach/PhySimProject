...
namespace VCX::Labs::Final {
    void DamBreakLevel::Setup(World & world, float breakThreshold) const {
        ...
        // Downstream structure: wood bases -> glass, with a ground target nearby.
        b.AddWood(glm::vec3(4.6f, 0.32f, .45f), glm::vec3(.28f, .33f, .28f));
        b.AddWood(glm::vec3(4.6f, 0.32f, -.45f), glm::vec3(.28f, .33f, .28f));
        b.AddGlass(glm::vec3(4.6f, 0.84f, 0.f), glm::vec3(.55f, .22f, .85f), 0.7f);
        world.Rigid.AddBox(BodyKind::Stone, glm::vec3(4.6f, 0.16f, 1.20f),
            glm::vec3(.38f, .16f, .38f), 0.f, Materials::Stone, t * 3.f);
        b.AddTarget(glm::vec3(4.6f, 0.68f, 1.20f), glm::vec3(.28f, .28f, .28f), 0.3f);

        // Right-side ground target on a static stone base.
        b.AddStone(glm::vec3(5.9f, 0.32f, 0.f), glm::vec3(.50f, .32f, .60f));
        b.AddTarget(glm::vec3(5.9f, 0.86f, 0.f), glm::vec3(.28f, .28f, .28f), 0.3f);

        // Third ground target near the downstream bank.
        world.Rigid.AddBox(BodyKind::Stone, glm::vec3(3.7f, 0.16f, -1.20f),
            glm::vec3(.38f, .16f, .38f), 0.f, Materials::Stone, t * 3.f);
        b.AddTarget(glm::vec3(3.7f, 0.66f, -1.20f), glm::vec3(.26f, .28f, .26f), 0.3f);
